...
//    private String title,des,imgURL,webURL;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newsTabLayout.addTab(newsTabLayout.newTab().setText("English"));
        newsTabLayout.addTab(newsTabLayout.newTab().setText("Bengali"));

//        newsTabLayout.getTabAt(0).setIcon(R.drawable.english);
//        newsTabLayout.getTabAt(1).setIcon(R.drawable.bengali);
